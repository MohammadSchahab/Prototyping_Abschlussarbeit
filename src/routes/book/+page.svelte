...
<svelte:head>
    <title>Service anfragen | HULA teschnische Hilfe</title>
</svelte:head>
            ...
            <div class="card shadow-sm">
                <div class="card-body p-4">
                    ...
                    >
                        ...
                        <!--  der Benutzer beschreibt den gewünschten Service -->
                        <div class="mb-4">
                            <label for="requestedService" class="form-label"
                        ...
                        <div class="mb-3">
                            ...
                            <input
                                ...
                                id="customerPhone"
                                name="customerPhone"
                                class="form-control {form?.errors?.customerPhone
                                    ? 'is-invalid'
                                    : ''}"
                        ...
                        <div class="mb-3">
                            ...
                            <input
                                ...
                                id="street"
                                name="street"
                                class="form-control {form?.errors?.street
                                    ? 'is-invalid'
                                    : ''}"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-8">
                                ...
                                <input
                                    ...
                                    id="city"
                                    name="city"
                                    class="form-control {form?.errors?.city
                                        ? 'is-invalid'
                                        : ''}"
